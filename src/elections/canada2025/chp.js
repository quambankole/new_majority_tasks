...
class Chp2025Scraper extends PartyScraper {
    ...
    async scrapeCandidateEmail(url, name) {
        try {
            ...
            // Look for a mailto: link in the candidate's profile.
    ...
    async scrape() {
        ...
        await this.goToPage('https://www.chp.ca/candidates/');
        await this.page.waitForSelector('#nav_cat_archive li > ul > li');

        // Extract candidate info from the candidates list.
        ...
        await this.saveToFile(unique, 'output/canada2025/candidates-chp.json');
        await this.closeBrowser();
    }
}

export default Chp2025Scraper;